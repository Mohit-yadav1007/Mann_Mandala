      ...
      <div className="mx-auto max-w-6xl px-4 py-16 md:py-20">
            ...
            <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-3 md:gap-4">
              {FALLBACK_ITEMS.map((it, i) => (
                <button
                  ...
                  className="group overflow-hidden rounded-lg border border-slate-200 bg-white hover:shadow-md hover-raise animate-in-up"
        ...
        <div className="mt-10 flex justify-center">
          <a
            ...
            className="inline-block rounded-md bg-gradient-to-r from-amber-500 to-sky-500 p-[2px] hover:from-amber-600 hover:to-sky-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50"
          >
            <span className="block rounded-md bg-white px-5 py-2.5 text-sm font-medium text-slate-900 hover-raise">
              Follow on Instagram
            </span>
          </a>
        </div>
