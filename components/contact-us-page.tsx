...
export default function ContactUsPage() {
  ...
  const emailHref = "mailto:mannmandala07@gmail.com?subject=Inquiry%20about%20Mann%20Mandalas&body=Hi%20Mann%20Mandalas%20team,%0D%0A%0D%0AI%20would%20like%20to%20inquire%20about..."
      ...
      <section className="relative py-16 sm:py-20 md:py-24 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-3 sm:px-4">
          ...
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-amber-800 mb-6 leading-tight">
              Contact Us
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl text-amber-700 max-w-3xl mx-auto leading-relaxed">
