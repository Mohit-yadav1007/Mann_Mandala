...
export default function Hero() {
  const handleScroll = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault()
    const el = document.querySelector("#what-i-do")
      ...
      <div className="relative mx-auto max-w-5xl px-4 py-20 md:py-28">
        ...
        <div className="mt-10 flex items-center justify-center animate-pop-in">
          <a
            ...
            aria-label="Scroll down to What I Do"
            className="group inline-flex items-center gap-2 rounded-full border border-amber-300/70 bg-white/70 px-4 py-2 text-amber-700 backdrop-blur hover-raise focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-500/40"
          >
            <svg
              width="18"
              height="18"
