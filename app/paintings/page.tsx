...
export default function PaintingsPage() {
  return (
    <main className="min-h-screen">
      ...
      <section className="relative py-10 sm:py-12 md:py-24 overflow-hidden">
        <div className="absolute inset-0 -z-10 bg-amber-50/50"></div>
        <div className="container mx-auto px-3 sm:px-4 lg:px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <DecorFrame>
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-amber-800 mb-2 sm:mb-3 md:mb-4 leading-tight">Mandala Paintings</h1>
              <p className="text-sm sm:text-base lg:text-lg text-amber-700 leading-relaxed">Explore our collection of handcrafted mandala artworks</p>
            </DecorFrame>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-12 md:py-16 bg-white">
        <div className="container mx-auto px-3 sm:px-4 lg:px-6">
          ...
          <div className="max-w-4xl mx-auto mt-6 sm:mt-6 md:mt-8">
            <div className="prose prose-sm sm:prose-base prose-amber mx-auto px-2 sm:px-4">
      ...
      <section className="py-10 sm:py-12 md:py-16 bg-amber-50/30">
