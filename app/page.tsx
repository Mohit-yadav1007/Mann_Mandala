...
export default function Page() {
  ...
  const galleryImages = [
    "/images/painting/p1.jpeg",
    "/images/painting/p2.jpeg", 
    "/images/painting/p3.jpeg",
    "/images/painting/p4.jpeg",
    "/images/painting/p5.jpeg",
    "/images/painting/p6.jpeg",
    "/images/painting/p7.jpeg",
    "/images/painting/p8.jpeg",
    "/images/painting/p9.jpeg",
    "/images/painting/p10.jpeg",
  ]
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-amber-50 to-white">
      ...
      <section className="relative min-h-[70vh] sm:min-h-[75vh] flex items-center justify-center bg-white">
        ...
        <div className="relative z-10 text-center max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-3.5 justify-center items-center px-4">
            <button 
      ...
      <section className="py-12 sm:py-20 md:py-32 bg-gradient-to-br from-amber-50 to-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="mb-12 sm:mb-16">
            <h3 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-8">Featured Artworks</h3>
                  ...
                  {[...featuredImages, ...featuredImages].map((src, i) => (
                    <li key={`featured-marquee-${i}`} className="w-[220px] sm:w-[260px] md:w-[300px] h-36 sm:h-44 md:h-52 flex-shrink-0">
                      <img
                        ...
                        className="w-full h-full object-cover rounded-xl sm:rounded-2xl shadow-md hover:shadow-lg transition-shadow"
                      />
                    </li>
                  ))}
                </ul>
      ...
      <section className="py-12 sm:py-20 md:py-32 bg-white text-slate-800 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5 sm:opacity-10">
          <img src="/images/floral-gold.png" alt="" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex items-center justify-center gap-4 sm:gap-6 mb-8 sm:mb-12">
            ...
            {/* LinkedIn */}
            <a href="https://linkedin.com/in/mann-mandalas" target="_blank" rel="noopener noreferrer" className="w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-sky-600 flex items-center justify-center shadow-md hover:shadow-lg transition-shadow">
              <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
